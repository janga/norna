...
visual defaults, section metadata can select a named typography preset or
surface, and Markdown blocks place managed media in the content flow.
...
The two sections on this page use explicit surface choices in their content
frontmatter. `palette` is the site-wide visual family; `surface` only chooses
between the palette's base, soft and emphasis treatments.
