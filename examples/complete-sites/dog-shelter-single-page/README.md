...
|
[View source](https://github.com/janga/norna/tree/main/examples/complete-sites/dog-shelter-single-page)
...
```sh
node bin/norna.mjs --site-dir examples/complete-sites/dog-shelter-single-page/site dev:local
```
