...
### Navigation path <small>Breadcrumbs</small> {#navigation-path-small-breadcrumbs-small}
...
1.  This feature flag is not compatible with
    `navigation.expand`, as navigation expansion requires
...
1.  This feature flag is not compatible with `toc.integrate`,
...
1.  This feature flag is not compatible with
    `navigation.indexes`, as sections cannot host the
...
### Hiding the navigation path {#hiding-the-navigation-path}
