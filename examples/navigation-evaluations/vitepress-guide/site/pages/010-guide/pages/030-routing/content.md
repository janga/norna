...
## Root and Source Directory {#root-and-source-directory}
...
### Linking to Non-VitePress Pages {#linking-to-non-vitepress-pages}
...
## Generating Clean URLs {#generating-clean-urls}
...
### Type-safe loader with `defineRoutes` {#type-safe-loader-with-defineroutes}
...
### Watching Template and Data Files {#watching-template-and-data-files}
