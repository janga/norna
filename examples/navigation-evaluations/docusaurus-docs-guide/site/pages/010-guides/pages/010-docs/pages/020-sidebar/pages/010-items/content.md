...
## Doc: link to a doc {#doc-link-to-a-doc}
...
## Link: link to any page {#link-link-to-any-page}
...
## HTML: render custom markup {#html-render-custom-markup}
...
## Category: create a hierarchy {#category-create-a-hierarchy}
