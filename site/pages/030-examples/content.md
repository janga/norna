...
defined model of content, presentation, configuration, pages and assets.
...
- title: Dog shelter: single page
  text: A complete single page site with two homepage sections and no pages.
...
- title: Dog shelter: multi-page
  text: A complete site with a homepage and ordered pages for dogs and adoption.
