...
Content syntax, Commands, and Reader behavior. Three branches have a pilot
here. The final site would keep Getting Started, Examples and FAQ alongside
Reference rather than mixing their different purposes into each entry.

## Review three kinds of answer

| Page | Question to answer from the reference |
| --- | --- |
| [Appearance](/reference/configuration/appearance/) | Why does a reader still see Light after the site owner chooses dark? |
| [Sidenotes](/reference/content/sidenotes/) | Can one paragraph have two notes, and where will they appear? |
| [page:move](/reference/commands/move/) | What changes, what remains untouched, and when will the command refuse a move? |
