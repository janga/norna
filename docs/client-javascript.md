...
| Current-section tracking | Yes, when `navigation.sectionTracking` is enabled and the page uses `tree` navigation | Page and contents links remain usable, but the contents-rail marker does not follow scrolling. |
