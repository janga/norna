...
| Visitor-selectable color mode | Yes, throughout a site with `colorMode.allowSelection: true` | The configured default still applies, but the selector cannot apply or remember another choice. |
