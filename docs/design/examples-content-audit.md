...
| Sidenotes | The named reference and definition match the displayed source. Margin placement is conditional on available space; ordinary reference footnotes remain at the page end. | Exact source; shared Markdown model; `docs/content.md#side-notes`; responsive content styles |
