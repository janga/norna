...
Keep shallow documentation trees compact by placing the current page's H2/H3
outline beneath that page in the left navigation rail. Preserve a separate
...
- At one or two visible levels, place only the current page's H2/H3 outline
...
- Canonical product documentation waits for human evaluation of the shallow
  and deep examples because this change alters visible navigation.
