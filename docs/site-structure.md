...
`theme.md` is required. It normally selects a complete preset and may add
focused visual overrides.
...
- `site/content.md`: homepage page file with editable content, Markdown
  sections, optional section metadata, Norna image and card blocks, alt text, and
  captions.
  See [Content](content.md).
- `site/images/<section-id>/`: original source images.
- `site/routes/<NNN-route-id>/content.md`: optional route page files.
